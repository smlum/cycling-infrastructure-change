...
of high-comfort infrastructure rose from **5% to 76%** —
a gain of **71 percentage points**.
Per capita, nothing else came close.
...
**64% to 69%** — a smaller percentage-point gain than Victoria,
but from a much higher base, and across a city of 1.6 million.

Central to this was the **REV** — Réseau Express Vélo.
A set of connected and protected lanes built explicitly as
cycling rapid transit, not just recreational paths. This framing matters.
...
Montreal is large and uneven.
Gains have concentrated in the central plateau, whereas
outer arrondissements have seen less attention.
The city-wide number is still a winner, but it masks some uneven geography.

---

### 🚧 Toronto: measured progress

Toronto did do significant work during this period.
...
tell a more modest story: access moved from **9% to 16%** —
...
Every city moved in the right direction.
But the scale of ambition varied enormously —
and that shows up clearly in the numbers.

```{python}
#| label: divergence
#| fig-cap: "Population-weighted share of residents within 300 m of high-comfort cycling infrastructure, 2019 and 2024. Population is from the 2021 census."
#| out-width: 100%
#| fig-dpi: 120
...
These results are, on balance, encouraging.

Victoria shows what rapid, focused investment can achieve in a smaller city —
three-quarters of residents reached in five years, from a near-zero base.
Montreal shows what sustained commitment looks like across a large city
and successive administrations: steady gains, compounding over time.

Both are templates. National cycling data will be updated again in 2026,
and the question is whether other cities have started to follow them.
